      ...
      <div className="row">
        <div className="col-md-2 bg-dark text-white" style={{ minHeight: '100vh' }}>
          <div className="list-group ">
            <h5 className="list-group-item list-group-item-action list-group-item-dark">Bảng điều khiển</h5>
            <a href="/admin/products" className="list-group-item list-group-item-action list-group-item-dark">Danh mục sản phẩm</a>
            <a href="/admin/categories" className="list-group-item list-group-item-action list-group-item-dark">Quản lý sản phẩm</a>
